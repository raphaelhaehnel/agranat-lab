...
static PyCodeObject *codeobj_ba3584cfb4b39429cf2f38b278c2a242;
/* For use in "MainProgram.c". */
PyCodeObject *codeobj_main = NULL;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_ba3584cfb4b39429cf2f38b278c2a242 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[7], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_ba3584cfb4b39429cf2f38b278c2a242;
    ...
    // Module code.
    // Frame without reuse.
    frame_ba3584cfb4b39429cf2f38b278c2a242 = MAKE_MODULE_FRAME(codeobj_ba3584cfb4b39429cf2f38b278c2a242, module___main__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_ba3584cfb4b39429cf2f38b278c2a242);
    assert(Py_REFCNT(frame_ba3584cfb4b39429cf2f38b278c2a242) == 2);

    // Framed code:
    {
        PyObject *tmp_imported_value_1;
        frame_ba3584cfb4b39429cf2f38b278c2a242->m_frame.f_lineno = 1;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_ba3584cfb4b39429cf2f38b278c2a242);
#endif
    popFrameStack();

    assertFrameObject(frame_ba3584cfb4b39429cf2f38b278c2a242);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_ba3584cfb4b39429cf2f38b278c2a242, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_ba3584cfb4b39429cf2f38b278c2a242->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_ba3584cfb4b39429cf2f38b278c2a242, exception_lineno);
    }
